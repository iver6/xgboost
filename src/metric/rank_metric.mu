...
#include "../common/device_helpers.muh"         // for MakeTransformIterator
#include "../common/optional_weight.h"          // for MakeOptionalWeights
#include "../common/ranking_utils.muh"          // for CalcQueriesDCG, NDCGCache
...
PackedReduceResult NDCGScore(Context const *ctx, MetaInfo const &info,
  ...
  ltr::musa_impl::CalcQueriesDCG(ctx, d_label, d_sorted_idx, p.ndcg_exp_gain, d_group_ptr, p.TopK(),
                                 d_out_dcg);
  ...
  auto pair = thrust::reduce(ctx->MUSACtx()->CTP(), it, it + d_out_dcg.Size(),
